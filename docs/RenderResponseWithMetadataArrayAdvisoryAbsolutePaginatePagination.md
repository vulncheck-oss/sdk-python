...
render.ResponseWithMetadata-array_advisory_Absolute-paginate_Pagination
...
**data** | [**List[AdvisoryAbsolute]**](AdvisoryAbsolute.md) | Data is the data returned by the endpoint | [optional] 
