...
render.ResponseWithMetadata-array_advisory_NCSC-paginate_Pagination
...
**data** | [**List[AdvisoryNCSC]**](AdvisoryNCSC.md) | Data is the data returned by the endpoint | [optional] 
