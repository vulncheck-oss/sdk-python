...
render.ResponseWithMetadata-array_advisory_ABBAdvisory-paginate_Pagination
...
**data** | [**List[AdvisoryABBAdvisory]**](AdvisoryABBAdvisory.md) | Data is the data returned by the endpoint | [optional] 
