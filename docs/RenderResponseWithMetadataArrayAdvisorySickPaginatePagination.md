...
render.ResponseWithMetadata-array_advisory_Sick-paginate_Pagination
...
**data** | [**List[AdvisorySick]**](AdvisorySick.md) | Data is the data returned by the endpoint | [optional] 
