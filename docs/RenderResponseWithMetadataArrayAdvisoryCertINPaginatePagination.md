...
render.ResponseWithMetadata-array_advisory_CertIN-paginate_Pagination
...
**data** | [**List[AdvisoryCertIN]**](AdvisoryCertIN.md) | Data is the data returned by the endpoint | [optional] 
