...
render.ResponseWithMetadata-array_advisory_VMWareAdvisory-paginate_Pagination
...
**data** | [**List[AdvisoryVMWareAdvisory]**](AdvisoryVMWareAdvisory.md) | Data is the data returned by the endpoint | [optional] 
