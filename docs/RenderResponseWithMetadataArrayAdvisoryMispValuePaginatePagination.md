...
render.ResponseWithMetadata-array_advisory_MispValue-paginate_Pagination
...
**data** | [**List[AdvisoryMispValue]**](AdvisoryMispValue.md) | Data is the data returned by the endpoint | [optional] 
