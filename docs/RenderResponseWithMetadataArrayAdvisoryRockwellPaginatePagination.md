...
render.ResponseWithMetadata-array_advisory_Rockwell-paginate_Pagination
...
**data** | [**List[AdvisoryRockwell]**](AdvisoryRockwell.md) | Data is the data returned by the endpoint | [optional] 
