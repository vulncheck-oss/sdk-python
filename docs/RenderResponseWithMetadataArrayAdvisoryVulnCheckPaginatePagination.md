...
render.ResponseWithMetadata-array_advisory_VulnCheck-paginate_Pagination
...
**data** | [**List[AdvisoryVulnCheck]**](AdvisoryVulnCheck.md) | Data is the data returned by the endpoint | [optional] 
