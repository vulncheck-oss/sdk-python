...
render.ResponseWithMetadata-array_advisory_JVNAdvisoryItem-paginate_Pagination
...
**data** | [**List[AdvisoryJVNAdvisoryItem]**](AdvisoryJVNAdvisoryItem.md) | Data is the data returned by the endpoint | [optional] 
