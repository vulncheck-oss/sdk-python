...
render.ResponseWithMetadata-array_advisory_CheckPoint-paginate_Pagination
...
**data** | [**List[AdvisoryCheckPoint]**](AdvisoryCheckPoint.md) | Data is the data returned by the endpoint | [optional] 
