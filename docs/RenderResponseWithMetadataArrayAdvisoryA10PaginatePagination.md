...
render.ResponseWithMetadata-array_advisory_A10-paginate_Pagination
...
**data** | [**List[AdvisoryA10]**](AdvisoryA10.md) | Data is the data returned by the endpoint | [optional] 
