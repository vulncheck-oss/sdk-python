...
render.ResponseWithMetadata-array_advisory_PKCert-paginate_Pagination
...
**data** | [**List[AdvisoryPKCert]**](AdvisoryPKCert.md) | Data is the data returned by the endpoint | [optional] 
