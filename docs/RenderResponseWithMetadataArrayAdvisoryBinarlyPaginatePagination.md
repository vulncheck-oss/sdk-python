...
render.ResponseWithMetadata-array_advisory_Binarly-paginate_Pagination
...
**data** | [**List[AdvisoryBinarly]**](AdvisoryBinarly.md) | Data is the data returned by the endpoint | [optional] 
