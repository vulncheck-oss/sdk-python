...
render.ResponseWithMetadata-array_advisory_QualysQID-paginate_Pagination
...
**data** | [**List[AdvisoryQualysQID]**](AdvisoryQualysQID.md) | Data is the data returned by the endpoint | [optional] 
