...
render.ResponseWithMetadata-array_advisory_SalesForce-paginate_Pagination
...
**data** | [**List[AdvisorySalesForce]**](AdvisorySalesForce.md) | Data is the data returned by the endpoint | [optional] 
