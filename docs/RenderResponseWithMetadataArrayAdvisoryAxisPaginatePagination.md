...
render.ResponseWithMetadata-array_advisory_Axis-paginate_Pagination
...
**data** | [**List[AdvisoryAxis]**](AdvisoryAxis.md) | Data is the data returned by the endpoint | [optional] 
