...
render.ResponseWithMetadata-array_advisory_Tencent-paginate_Pagination
...
**data** | [**List[AdvisoryTencent]**](AdvisoryTencent.md) | Data is the data returned by the endpoint | [optional] 
