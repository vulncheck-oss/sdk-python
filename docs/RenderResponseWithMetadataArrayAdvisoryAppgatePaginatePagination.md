...
render.ResponseWithMetadata-array_advisory_Appgate-paginate_Pagination
...
**data** | [**List[AdvisoryAppgate]**](AdvisoryAppgate.md) | Data is the data returned by the endpoint | [optional] 
