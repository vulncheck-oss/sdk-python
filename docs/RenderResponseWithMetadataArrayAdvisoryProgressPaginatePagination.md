...
render.ResponseWithMetadata-array_advisory_Progress-paginate_Pagination
...
**data** | [**List[AdvisoryProgress]**](AdvisoryProgress.md) | Data is the data returned by the endpoint | [optional] 
