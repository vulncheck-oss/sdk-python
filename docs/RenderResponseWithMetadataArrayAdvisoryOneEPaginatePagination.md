...
render.ResponseWithMetadata-array_advisory_OneE-paginate_Pagination
...
**data** | [**List[AdvisoryOneE]**](AdvisoryOneE.md) | Data is the data returned by the endpoint | [optional] 
