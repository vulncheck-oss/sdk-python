...
render.ResponseWithMetadata-array_advisory_SuseSecurity-paginate_Pagination
...
**data** | [**List[AdvisorySuseSecurity]**](AdvisorySuseSecurity.md) | Data is the data returned by the endpoint | [optional] 
