...
render.ResponseWithMetadata-array_advisory_FlattSecurity-paginate_Pagination
...
**data** | [**List[AdvisoryFlattSecurity]**](AdvisoryFlattSecurity.md) | Data is the data returned by the endpoint | [optional] 
