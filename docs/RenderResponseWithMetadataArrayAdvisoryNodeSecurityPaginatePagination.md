...
render.ResponseWithMetadata-array_advisory_NodeSecurity-paginate_Pagination
...
**data** | [**List[AdvisoryNodeSecurity]**](AdvisoryNodeSecurity.md) | Data is the data returned by the endpoint | [optional] 
