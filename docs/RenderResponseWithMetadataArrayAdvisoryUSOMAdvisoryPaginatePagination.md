...
render.ResponseWithMetadata-array_advisory_USOMAdvisory-paginate_Pagination
...
**data** | [**List[AdvisoryUSOMAdvisory]**](AdvisoryUSOMAdvisory.md) | Data is the data returned by the endpoint | [optional] 
