...
render.ResponseWithMetadata-array_advisory_NI-paginate_Pagination
...
**data** | [**List[AdvisoryNI]**](AdvisoryNI.md) | Data is the data returned by the endpoint | [optional] 
