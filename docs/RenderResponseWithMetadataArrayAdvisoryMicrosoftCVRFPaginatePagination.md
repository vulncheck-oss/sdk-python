...
render.ResponseWithMetadata-array_advisory_MicrosoftCVRF-paginate_Pagination
...
**data** | [**List[AdvisoryMicrosoftCVRF]**](AdvisoryMicrosoftCVRF.md) | Data is the data returned by the endpoint | [optional] 
