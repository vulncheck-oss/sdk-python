...
render.ResponseWithMetadata-array_advisory_IncibeAdvisory-paginate_Pagination
...
**data** | [**List[AdvisoryIncibeAdvisory]**](AdvisoryIncibeAdvisory.md) | Data is the data returned by the endpoint | [optional] 
