...
render.ResponseWithMetadata-array_advisory_Dell-paginate_Pagination
...
**data** | [**List[AdvisoryDell]**](AdvisoryDell.md) | Data is the data returned by the endpoint | [optional] 
