...
render.ResponseWithMetadata-array_advisory_ZeroDayAdvisory-paginate_Pagination
...
**data** | [**List[AdvisoryZeroDayAdvisory]**](AdvisoryZeroDayAdvisory.md) | Data is the data returned by the endpoint | [optional] 
