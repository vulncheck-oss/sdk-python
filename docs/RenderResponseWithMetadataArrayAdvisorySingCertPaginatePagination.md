...
render.ResponseWithMetadata-array_advisory_SingCert-paginate_Pagination
...
**data** | [**List[AdvisorySingCert]**](AdvisorySingCert.md) | Data is the data returned by the endpoint | [optional] 
