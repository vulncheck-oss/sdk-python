...
render.ResponseWithMetadata-array_advisory_MetaData-paginate_Pagination
...
**data** | [**List[AdvisoryMetaData]**](AdvisoryMetaData.md) | Data is the data returned by the endpoint | [optional] 
