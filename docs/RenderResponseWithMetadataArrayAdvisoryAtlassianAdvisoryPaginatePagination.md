...
render.ResponseWithMetadata-array_advisory_AtlassianAdvisory-paginate_Pagination
...
**data** | [**List[AdvisoryAtlassianAdvisory]**](AdvisoryAtlassianAdvisory.md) | Data is the data returned by the endpoint | [optional] 
