...
render.ResponseWithMetadata-array_advisory_USD-paginate_Pagination
...
**data** | [**List[AdvisoryUSD]**](AdvisoryUSD.md) | Data is the data returned by the endpoint | [optional] 
