...
render.ResponseWithMetadata-array_advisory_Xen-paginate_Pagination
...
**data** | [**List[AdvisoryXen]**](AdvisoryXen.md) | Data is the data returned by the endpoint | [optional] 
