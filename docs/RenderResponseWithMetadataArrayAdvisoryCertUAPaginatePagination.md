...
render.ResponseWithMetadata-array_advisory_CertUA-paginate_Pagination
...
**data** | [**List[AdvisoryCertUA]**](AdvisoryCertUA.md) | Data is the data returned by the endpoint | [optional] 
