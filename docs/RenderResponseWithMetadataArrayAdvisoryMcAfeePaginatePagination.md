...
render.ResponseWithMetadata-array_advisory_McAfee-paginate_Pagination
...
**data** | [**List[AdvisoryMcAfee]**](AdvisoryMcAfee.md) | Data is the data returned by the endpoint | [optional] 
