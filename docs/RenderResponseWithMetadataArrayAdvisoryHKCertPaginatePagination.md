...
render.ResponseWithMetadata-array_advisory_HKCert-paginate_Pagination
...
**data** | [**List[AdvisoryHKCert]**](AdvisoryHKCert.md) | Data is the data returned by the endpoint | [optional] 
