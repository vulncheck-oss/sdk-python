...
render.ResponseWithMetadata-array_advisory_Abbott-paginate_Pagination
...
**data** | [**List[AdvisoryAbbott]**](AdvisoryAbbott.md) | Data is the data returned by the endpoint | [optional] 
