...
render.ResponseWithMetadata-array_advisory_NetApp-paginate_Pagination
...
**data** | [**List[AdvisoryNetApp]**](AdvisoryNetApp.md) | Data is the data returned by the endpoint | [optional] 
