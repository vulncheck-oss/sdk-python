...
render.ResponseWithMetadata-array_advisory_WatchGuard-paginate_Pagination
...
**data** | [**List[AdvisoryWatchGuard]**](AdvisoryWatchGuard.md) | Data is the data returned by the endpoint | [optional] 
