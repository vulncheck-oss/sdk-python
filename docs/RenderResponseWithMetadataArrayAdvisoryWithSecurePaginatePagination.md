...
render.ResponseWithMetadata-array_advisory_WithSecure-paginate_Pagination
...
**data** | [**List[AdvisoryWithSecure]**](AdvisoryWithSecure.md) | Data is the data returned by the endpoint | [optional] 
