...
render.ResponseWithMetadata-array_advisory_MicrosoftCSAF-paginate_Pagination
...
**data** | [**List[AdvisoryMicrosoftCSAF]**](AdvisoryMicrosoftCSAF.md) | Data is the data returned by the endpoint | [optional] 
