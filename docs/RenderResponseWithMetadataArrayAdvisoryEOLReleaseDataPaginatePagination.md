...
render.ResponseWithMetadata-array_advisory_EOLReleaseData-paginate_Pagination
...
**data** | [**List[AdvisoryEOLReleaseData]**](AdvisoryEOLReleaseData.md) | Data is the data returned by the endpoint | [optional] 
