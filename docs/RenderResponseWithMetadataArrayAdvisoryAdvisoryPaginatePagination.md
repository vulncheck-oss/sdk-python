...
render.ResponseWithMetadata-array_advisory_Advisory-paginate_Pagination
...
**data** | [**List[AdvisoryAdvisory]**](AdvisoryAdvisory.md) | Data is the data returned by the endpoint | [optional] 
