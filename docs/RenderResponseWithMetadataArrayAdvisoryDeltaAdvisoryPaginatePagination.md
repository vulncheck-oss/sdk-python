...
render.ResponseWithMetadata-array_advisory_DeltaAdvisory-paginate_Pagination
...
**data** | [**List[AdvisoryDeltaAdvisory]**](AdvisoryDeltaAdvisory.md) | Data is the data returned by the endpoint | [optional] 
