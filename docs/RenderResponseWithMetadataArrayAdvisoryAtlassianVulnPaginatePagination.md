...
render.ResponseWithMetadata-array_advisory_AtlassianVuln-paginate_Pagination
...
**data** | [**List[AdvisoryAtlassianVuln]**](AdvisoryAtlassianVuln.md) | Data is the data returned by the endpoint | [optional] 
