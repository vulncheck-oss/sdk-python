...
render.ResponseWithMetadata-array_advisory_Unify-paginate_Pagination
...
**data** | [**List[AdvisoryUnify]**](AdvisoryUnify.md) | Data is the data returned by the endpoint | [optional] 
