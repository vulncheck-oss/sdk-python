...
render.ResponseWithMetadata-array_advisory_Renesas-paginate_Pagination
...
**data** | [**List[AdvisoryRenesas]**](AdvisoryRenesas.md) | Data is the data returned by the endpoint | [optional] 
