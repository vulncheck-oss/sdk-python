...
render.ResponseWithMetadata-array_advisory_ApacheArrow-paginate_Pagination
...
**data** | [**List[AdvisoryApacheArrow]**](AdvisoryApacheArrow.md) | Data is the data returned by the endpoint | [optional] 
