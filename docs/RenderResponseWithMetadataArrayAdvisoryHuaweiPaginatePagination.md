...
render.ResponseWithMetadata-array_advisory_Huawei-paginate_Pagination
...
**data** | [**List[AdvisoryHuawei]**](AdvisoryHuawei.md) | Data is the data returned by the endpoint | [optional] 
