...
render.ResponseWithMetadata-array_advisory_Qualcomm-paginate_Pagination
...
**data** | [**List[AdvisoryQualcomm]**](AdvisoryQualcomm.md) | Data is the data returned by the endpoint | [optional] 
