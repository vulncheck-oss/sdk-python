...
render.ResponseWithMetadata-array_advisory_Gen-paginate_Pagination
...
**data** | [**List[AdvisoryGen]**](AdvisoryGen.md) | Data is the data returned by the endpoint | [optional] 
