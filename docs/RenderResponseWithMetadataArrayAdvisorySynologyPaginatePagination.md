...
render.ResponseWithMetadata-array_advisory_Synology-paginate_Pagination
...
**data** | [**List[AdvisorySynology]**](AdvisorySynology.md) | Data is the data returned by the endpoint | [optional] 
