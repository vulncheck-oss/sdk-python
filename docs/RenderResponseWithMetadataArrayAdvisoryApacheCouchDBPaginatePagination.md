...
render.ResponseWithMetadata-array_advisory_ApacheCouchDB-paginate_Pagination
...
**data** | [**List[AdvisoryApacheCouchDB]**](AdvisoryApacheCouchDB.md) | Data is the data returned by the endpoint | [optional] 
