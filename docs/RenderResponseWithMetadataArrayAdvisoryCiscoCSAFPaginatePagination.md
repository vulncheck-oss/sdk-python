...
render.ResponseWithMetadata-array_advisory_CiscoCSAF-paginate_Pagination
...
**data** | [**List[AdvisoryCiscoCSAF]**](AdvisoryCiscoCSAF.md) | Data is the data returned by the endpoint | [optional] 
