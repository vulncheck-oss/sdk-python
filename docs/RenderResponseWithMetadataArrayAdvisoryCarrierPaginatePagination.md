...
render.ResponseWithMetadata-array_advisory_Carrier-paginate_Pagination
...
**data** | [**List[AdvisoryCarrier]**](AdvisoryCarrier.md) | Data is the data returned by the endpoint | [optional] 
