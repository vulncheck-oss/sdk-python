...
render.ResponseWithMetadata-array_advisory_Update-paginate_Pagination
...
**data** | [**List[AdvisoryUpdate]**](AdvisoryUpdate.md) | Data is the data returned by the endpoint | [optional] 
