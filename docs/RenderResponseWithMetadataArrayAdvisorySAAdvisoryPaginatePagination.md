...
render.ResponseWithMetadata-array_advisory_SAAdvisory-paginate_Pagination
...
**data** | [**List[AdvisorySAAdvisory]**](AdvisorySAAdvisory.md) | Data is the data returned by the endpoint | [optional] 
