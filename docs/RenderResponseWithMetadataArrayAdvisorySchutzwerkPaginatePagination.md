...
render.ResponseWithMetadata-array_advisory_Schutzwerk-paginate_Pagination
...
**data** | [**List[AdvisorySchutzwerk]**](AdvisorySchutzwerk.md) | Data is the data returned by the endpoint | [optional] 
