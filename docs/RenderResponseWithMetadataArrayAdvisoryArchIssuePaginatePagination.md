...
render.ResponseWithMetadata-array_advisory_ArchIssue-paginate_Pagination
...
**data** | [**List[AdvisoryArchIssue]**](AdvisoryArchIssue.md) | Data is the data returned by the endpoint | [optional] 
