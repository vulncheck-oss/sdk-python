...
**source** | [**AdvisoryCirclSource**](AdvisoryCirclSource.md) |  | [optional] 
...
**x_gcve** | [**List[AdvisoryCirclXGcve]**](AdvisoryCirclXGcve.md) |  | [optional] 
**x_generator** | [**AdvisoryCirclXGenerator**](AdvisoryCirclXGenerator.md) |  | [optional] 
...
json = "{}"
# create an instance of AdvisoryCirclCna from a JSON string
advisory_circl_cna_instance = AdvisoryCirclCna.from_json(json)
# print the JSON string representation of the object
print(AdvisoryCirclCna.to_json())

# convert the object into a dict
advisory_circl_cna_dict = advisory_circl_cna_instance.to_dict()
# create an instance of AdvisoryCirclCna from a dict
advisory_circl_cna_from_dict = AdvisoryCirclCna.from_dict(advisory_circl_cna_dict)
```
