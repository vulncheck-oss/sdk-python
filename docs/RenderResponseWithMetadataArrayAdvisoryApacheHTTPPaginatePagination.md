...
render.ResponseWithMetadata-array_advisory_ApacheHTTP-paginate_Pagination
...
**data** | [**List[AdvisoryApacheHTTP]**](AdvisoryApacheHTTP.md) | Data is the data returned by the endpoint | [optional] 
