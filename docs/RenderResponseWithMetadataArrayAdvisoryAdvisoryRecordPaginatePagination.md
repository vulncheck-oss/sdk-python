...
render.ResponseWithMetadata-array_advisory_AdvisoryRecord-paginate_Pagination
...
**data** | [**List[AdvisoryAdvisoryRecord]**](AdvisoryAdvisoryRecord.md) | Data is the data returned by the endpoint | [optional] 
