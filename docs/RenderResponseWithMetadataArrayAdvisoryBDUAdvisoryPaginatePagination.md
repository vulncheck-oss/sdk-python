...
render.ResponseWithMetadata-array_advisory_BDUAdvisory-paginate_Pagination
...
**data** | [**List[AdvisoryBDUAdvisory]**](AdvisoryBDUAdvisory.md) | Data is the data returned by the endpoint | [optional] 
