...
render.ResponseWithMetadata-array_advisory_Syss-paginate_Pagination
...
**data** | [**List[AdvisorySyss]**](AdvisorySyss.md) | Data is the data returned by the endpoint | [optional] 
