...
render.ResponseWithMetadata-array_advisory_AVEVAAdvisory-paginate_Pagination
...
**data** | [**List[AdvisoryAVEVAAdvisory]**](AdvisoryAVEVAAdvisory.md) | Data is the data returned by the endpoint | [optional] 
