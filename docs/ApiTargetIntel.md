...
**contains_cve** | **bool** | Deprecated: use Summary.ContainsCVE instead. | [optional] 
**country** | **str** |  | [optional] 
**country_code** | **str** |  | [optional] 
**cpe** | **List[str]** |  | [optional] 
**cve** | **List[str]** | Deprecated: use Fingerprints[].CVEs for per-fingerprint attribution, or Summary for the aggregate count. | [optional] 
**cve_confirmed** | [**List[ApiCVEConfirmed]**](ApiCVEConfirmed.md) | Deprecated: use Fingerprints[].CVEs for per-fingerprint attribution, or Summary for the aggregate confirmed count. | [optional] 
...
**summary** | [**ApiTargetIntelSummary**](ApiTargetIntelSummary.md) |  | [optional] 
