...
class EndpointsApi:
    ...
    @validate_call
    def search_cpe_get_with_http_info(
        self,
        part: Annotated[Optional[StrictStr], Field(description="CPE part to lookup")] = None,
        vendor: Annotated[Optional[StrictStr], Field(description="CPE vendor to lookup")] = None,
        product: Annotated[Optional[StrictStr], Field(description="CPE product to lookup")] = None,
    ...
    @validate_call
    def search_cpe_get_without_preload_content(
        self,
        part: Annotated[Optional[StrictStr], Field(description="CPE part to lookup")] = None,
        vendor: Annotated[Optional[StrictStr], Field(description="CPE vendor to lookup")] = None,
        product: Annotated[Optional[StrictStr], Field(description="CPE product to lookup")] = None,
    ...
    @validate_call
    def search_cve_get_with_http_info(
        self,
        cve: Annotated[StrictStr, Field(description="CVE ID to search for (e.g. CVE-2024-1234)")],
        page: Annotated[Optional[StrictInt], Field(description="Page number (default: 1, page mode only)")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Maximum number of results per page (default: 500, max: 1000)")] = None,
    ...
    @validate_call
    def search_cve_get_without_preload_content(
        self,
        cve: Annotated[StrictStr, Field(description="CVE ID to search for (e.g. CVE-2024-1234)")],
        page: Annotated[Optional[StrictInt], Field(description="Page number (default: 1, page mode only)")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Maximum number of results per page (default: 500, max: 1000)")] = None,
