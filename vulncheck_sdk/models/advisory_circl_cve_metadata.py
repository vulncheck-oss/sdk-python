...
class AdvisoryCirclCveMetadata(BaseModel):
    """
    ...
    vuln_id: Optional[StrictStr] = Field(default=None, alias="vulnId")
    vulnerabilitylookup_history: Optional[List[List[StrictStr]]] = None
    __properties: ClassVar[List[str]] = ["assignerOrgId", "assignerShortName", "cveId", "datePublished", "dateRejected", "dateReserved", "dateUpdated", "requesterUserId", "serial", "state", "vulnId", "vulnerabilitylookup_history"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "vulnId": obj.get("vulnId"),
            "vulnerabilitylookup_history": obj.get("vulnerabilitylookup_history")
        })
        return _obj
