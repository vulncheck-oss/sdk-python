...
class AdvisoryAtredis(BaseModel):
    """
    AdvisoryAtredis
    """ # noqa: E501
    ...
    vendors: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["cve", "date_added", "products", "references", "summary", "title", "url", "vendors"]
