...
class AdvisoryOpenStack(BaseModel):
    """
    AdvisoryOpenStack
    """ # noqa: E501
    affects: Optional[List[StrictStr]] = None
    ...
    __properties: ClassVar[List[str]] = ["affects", "cve", "date_added", "id", "references", "summary", "title", "updated_at", "url"]
