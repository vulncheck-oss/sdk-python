...
class AdvisoryLolAdvs(BaseModel):
    """
    AdvisoryLolAdvs
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["cve", "date_added", "description", "id", "lol_json", "mitre_id", "references", "updated_at", "url"]
