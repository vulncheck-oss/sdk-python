...
class AdvisoryNetApp(BaseModel):
    """
    AdvisoryNetApp
    """ # noqa: E501
    ...
    ntap: Optional[StrictStr] = None
    references: Optional[List[StrictStr]] = None
    summary: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    updated_at: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cve", "date_added", "impact", "ntap", "references", "summary", "title", "updated_at", "url"]
