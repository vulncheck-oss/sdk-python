...
class AdvisoryCommVaultCVEDetails(BaseModel):
    """
    ...
    external_links: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["cve_id", "cvss", "description", "external_links"]
