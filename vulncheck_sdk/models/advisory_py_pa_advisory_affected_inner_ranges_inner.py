...
class AdvisoryPyPAAdvisoryAffectedInnerRangesInner(BaseModel):
    """
    AdvisoryPyPAAdvisoryAffectedInnerRangesInner
    """ # noqa: E501
    events: Optional[List[AdvisoryPyPAAdvisoryAffectedInnerRangesInnerEventsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [AdvisoryPyPAAdvisoryAffectedInnerRangesInnerEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
