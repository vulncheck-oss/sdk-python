...
class AdvisoryCVDSnapshot(BaseModel):
    """
    ...
    manifest_sha3: Optional[StrictStr] = None
    revision: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["as_of", "fetched_at", "manifest_sha3", "revision"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "manifest_sha3": obj.get("manifest_sha3"),
