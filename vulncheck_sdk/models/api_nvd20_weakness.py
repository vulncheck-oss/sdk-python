...
class ApiNVD20Weakness(BaseModel):
    """
    api.NVD20Weakness
    """ # noqa: E501
    description: Optional[List[ApiNVD20Description]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "description": [ApiNVD20Description.from_dict(_item) for _item in obj["description"]] if obj.get("description") is not None else None,
