...
class AdvisoryAtlassianAdvisory(BaseModel):
    """
    AdvisoryAtlassianAdvisory
    """ # noqa: E501
    affected_version: Optional[List[StrictStr]] = None
    cve: Optional[List[StrictStr]] = None
    date_added: Optional[StrictStr] = None
    detailed_summary: Optional[StrictStr] = Field(default=None, description="overloading in places with 'RiskAssessment' and other places with 'Description'")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "detailed_summary": obj.get("detailed_summary"),
