...
class AdvisoryMIdentification(BaseModel):
    """
    AdvisoryMIdentification
    """ # noqa: E501
    alias: Optional[AdvisoryIVal] = None
    id: Optional[AdvisoryIVal] = None
    __properties: ClassVar[List[str]] = ["alias", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alias": AdvisoryIVal.from_dict(obj["alias"]) if obj.get("alias") is not None else None,
            "id": AdvisoryIVal.from_dict(obj["id"]) if obj.get("id") is not None else None
        })
        return _obj
