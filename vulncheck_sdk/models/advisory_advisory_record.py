...
class AdvisoryAdvisoryRecord(BaseModel):
    """
    AdvisoryAdvisoryRecord
    """ # noqa: E501
    cve: Optional[List[StrictStr]] = None
    date_added: Optional[StrictStr] = None
    external_id: Optional[List[StrictStr]] = None
    lang: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    refsource: Optional[StrictStr] = None
    tags: Optional[List[StrictStr]] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cve", "date_added", "external_id", "lang", "name", "refsource", "tags", "url"]
