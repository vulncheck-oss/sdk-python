...
class AdvisoryDanfoss(BaseModel):
    ...
    cve_details: Optional[List[AdvisoryDanFossCVEDetails]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cve": obj.get("cve"),
            "cve_details": [AdvisoryDanFossCVEDetails.from_dict(_item) for _item in obj["cve_details"]] if obj.get("cve_details") is not None else None,
