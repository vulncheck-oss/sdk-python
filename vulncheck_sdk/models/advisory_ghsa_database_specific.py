...
class AdvisoryGHSADatabaseSpecific(BaseModel):
    """
    AdvisoryGHSADatabaseSpecific
    """ # noqa: E501
    cwe_ids: Optional[List[StrictStr]] = None
    github_reviewed: Optional[StrictBool] = None
    github_reviewed_at: Optional[StrictStr] = None
    nvd_published_at: Optional[StrictStr] = None
    severity: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cwe_ids", "github_reviewed", "github_reviewed_at", "nvd_published_at", "severity"]
