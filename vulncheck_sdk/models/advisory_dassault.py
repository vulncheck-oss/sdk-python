...
class AdvisoryDassault(BaseModel):
    """
    AdvisoryDassault
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["affected_products", "affected_versions", "cve", "date_added", "details", "severity", "title", "updated_at", "url"]
