...
class AdvisoryVulnCheckConfig(BaseModel):
    ...
    """ # noqa: E501
    config: Optional[List[AdvisoryNVD20Configuration]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": [AdvisoryNVD20Configuration.from_dict(_item) for _item in obj["config"]] if obj.get("config") is not None else None,
            "cve": obj.get("cve"),
