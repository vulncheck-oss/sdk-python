...
class EndpointsApi:
    ...
    @validate_call
    async def cpe_get_with_http_info(
        self,
        cpe: Annotated[StrictStr, Field(description="CPE designation to lookup")],
        is_vulnerable: Annotated[Optional[StrictStr], Field(description="Filter by vulnerability status (true/false). Defaults to false if not provided.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def cpe_get_without_preload_content(
        self,
        cpe: Annotated[StrictStr, Field(description="CPE designation to lookup")],
        is_vulnerable: Annotated[Optional[StrictStr], Field(description="Filter by vulnerability status (true/false). Defaults to false if not provided.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def entitlements_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def entitlements_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def openapi_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def openapi_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def pdns_vulncheck_c2_get(
        self,
    ...
    @validate_call
    async def pdns_vulncheck_c2_get_with_http_info(
        self,
        format: Annotated[Optional[StrictStr], Field(description="Format of the Hostnames in the response (Defaults To: text)")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def pdns_vulncheck_c2_get_without_preload_content(
        self,
        format: Annotated[Optional[StrictStr], Field(description="Format of the Hostnames in the response (Defaults To: text)")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def purl_get_with_http_info(
        self,
        purl: Annotated[StrictStr, Field(description="URL string used to identify and locate a software package")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def purl_get_without_preload_content(
        self,
        purl: Annotated[StrictStr, Field(description="URL string used to identify and locate a software package")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def purls_post_with_http_info(
        self,
        request_body: Annotated[List[StrictStr], Field(description="PURL strings used to identify and locate software packages")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def purls_post_without_preload_content(
        self,
        request_body: Annotated[List[StrictStr], Field(description="PURL strings used to identify and locate software packages")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def rules_initial_access_type_get(
        self,
    ...
    @validate_call
    async def rules_initial_access_type_get_with_http_info(
        self,
        type: Annotated[StrictStr, Field(description="Type of ruleset to retrieve")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def rules_initial_access_type_get_without_preload_content(
        self,
        type: Annotated[StrictStr, Field(description="Type of ruleset to retrieve")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def search_cve_get(
        self,
        cve: Annotated[StrictStr, Field(description="CVE ID to search for (e.g. CVE-2024-1234)")],
        page: Annotated[Optional[StrictInt], Field(description="Page number (default: 1, page mode only)")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Maximum number of results per page (default: 500, max: 1000)")] = None,
        cursor: Annotated[Optional[StrictStr], Field(description="Continue cursor paging, or use an empty value to start cursor paging")] = None,
        start_cursor: Annotated[Optional[StrictStr], Field(description="Start cursor paging")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Returns all records referencing the specified CVE across all accessible indices. Results are aggregated from multiple data sources including advisories, exploits, threat intelligence, and vulnerability databases. Metadata is returned in the _meta field.

        :param cve: CVE ID to search for (e.g. CVE-2024-1234) (required)
        :type cve: str
        :param page: Page number (default: 1, page mode only)
        :type page: int
        :param limit: Maximum number of results per page (default: 500, max: 1000)
        :type limit: int
        :param cursor: Continue cursor paging, or use an empty value to start cursor paging
        :type cursor: str
        :param start_cursor: Start cursor paging
        ...
        _param = self._search_cve_get_serialize(
            cve=cve,
            page=page,
            limit=limit,
            cursor=cursor,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RenderResponseWithMetadataArrayIndexCveSearchHitIndexCveSearchMeta",
            '400': "str",
            '401': "str",
            '500': "str",
        }
    ...
    @validate_call
    async def search_cve_get_with_http_info(
        self,
        cve: Annotated[StrictStr, Field(description="CVE ID to search for (e.g. CVE-2024-1234)")],
        page: Annotated[Optional[StrictInt], Field(description="Page number (default: 1, page mode only)")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Maximum number of results per page (default: 500, max: 1000)")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=1)] = 0,
    ) -> ApiResponse[RenderResponseWithMetadataArrayIndexCveSearchHitIndexCveSearchMeta]:
        """Search all indices for a CVE
    ...
    @validate_call
    async def search_cve_get_without_preload_content(
        self,
        cve: Annotated[StrictStr, Field(description="CVE ID to search for (e.g. CVE-2024-1234)")],
        page: Annotated[Optional[StrictInt], Field(description="Page number (default: 1, page mode only)")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Maximum number of results per page (default: 500, max: 1000)")] = None,
    ...
    @validate_call
    async def tags_vulncheck_c2_get(
        self,
    ...
    @validate_call
    async def tags_vulncheck_c2_get_with_http_info(
        self,
        format: Annotated[Optional[StrictStr], Field(description="Format of the IP Addresses in the response (Defaults To: text)")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def tags_vulncheck_c2_get_without_preload_content(
        self,
        format: Annotated[Optional[StrictStr], Field(description="Format of the IP Addresses in the response (Defaults To: text)")] = None,
        _request_timeout: Union[
            None,
