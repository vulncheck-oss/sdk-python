...
class AdvisoryEmergingThreatsSnort(BaseModel):
    """
    ...
    rule_disabled: Optional[StrictBool] = None
    rule_name: Optional[StrictStr] = None
    sid: Optional[StrictInt] = None
    updated_at: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cve", "date_added", "references", "rev", "rule_disabled", "rule_name", "sid", "updated_at", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rev": obj.get("rev"),
            "rule_disabled": obj.get("rule_disabled"),
