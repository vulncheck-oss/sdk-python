...
class ApiNVD20AffectedVersion(BaseModel):
    """
    api.NVD20AffectedVersion
    """ # noqa: E501
    changes: Optional[List[ApiNVD20AffectedVersionChange]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "changes": [ApiNVD20AffectedVersionChange.from_dict(_item) for _item in obj["changes"]] if obj.get("changes") is not None else None,
