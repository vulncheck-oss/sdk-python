...
class AdvisoryKasperskyICSCERTAdvisory(BaseModel):
    """
    ...
    klcert_id: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cve", "cwe", "date_added", "klcert_id", "title", "url"]
