...
class AdvisoryVulnrichmentContainers(BaseModel):
    """
    AdvisoryVulnrichmentContainers
    """ # noqa: E501
    adp: Optional[List[AdvisoryADP]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "adp": [AdvisoryADP.from_dict(_item) for _item in obj["adp"]] if obj.get("adp") is not None else None,
