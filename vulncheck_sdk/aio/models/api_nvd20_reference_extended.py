...
class ApiNVD20ReferenceExtended(BaseModel):
    """
    ...
    previous_url: Optional[StrictStr] = None
    refsource: Optional[StrictStr] = None
    source: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    tags: Optional[List[StrictStr]] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["date_added", "external_id", "lang", "name", "previous_url", "refsource", "source", "status", "tags", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lang": obj.get("lang"),
            "name": obj.get("name"),
            "previous_url": obj.get("previous_url"),
