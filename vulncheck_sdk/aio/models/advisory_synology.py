...
class AdvisorySynology(BaseModel):
    """
    AdvisorySynology
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["affected_products", "cve", "date_added", "id", "last_updated", "references", "severity", "status", "summary", "title", "url"]
