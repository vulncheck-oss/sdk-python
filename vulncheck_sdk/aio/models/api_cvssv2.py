...
class ApiCVSSV2(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessComplexity", "accessVector", "authentication", "availabilityImpact", "baseScore", "confidentialityImpact", "integrityImpact", "vectorString", "version"]
