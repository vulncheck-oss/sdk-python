...
class AdvisoryBotnet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["associated_capecs", "associated_cwes", "associated_mitre_attack_techniques", "botnet_name", "cve", "cve_references", "date_added", "malpedia_url", "tools"]
