...
class AdvisoryPackageStat(BaseModel):
    """
    AdvisoryPackageStat
    """ # noqa: E501
    cpe: Optional[StrictStr] = None
    fix_state: Optional[StrictStr] = None
    package_name: Optional[StrictStr] = None
    product_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cpe", "fix_state", "package_name", "product_name"]
