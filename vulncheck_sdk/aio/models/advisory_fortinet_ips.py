...
class AdvisoryFortinetIPS(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["affected", "cve", "date_added", "epss", "id", "references", "summary", "title", "updated_at", "url"]
