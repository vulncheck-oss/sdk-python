...
class AdvisoryCESA(BaseModel):
    ...
    os_release: Optional[StrictStr] = Field(default=None, alias="osRelease")
    packages: Optional[List[AdvisoryCentosPackage]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "packages": [AdvisoryCentosPackage.from_dict(_item) for _item in obj["packages"]] if obj.get("packages") is not None else None,
