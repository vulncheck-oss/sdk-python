...
class AdvisoryBoschAdvisory(BaseModel):
    """
    AdvisoryBoschAdvisory
    """ # noqa: E501
    bosch_id: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["bosch_id", "cve", "cwe", "date_added", "date_last_revised", "title", "url"]
