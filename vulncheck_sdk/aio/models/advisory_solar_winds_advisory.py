...
class AdvisorySolarWindsAdvisory(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["affected_products", "cve", "cvss_score", "date_added", "fixed_version", "severity", "summary", "title", "updated_at", "url"]
