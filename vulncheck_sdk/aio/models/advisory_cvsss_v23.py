...
class AdvisoryCvsssV23(BaseModel):
    """
    AdvisoryCvsssV23
    """ # noqa: E501
    basescore: Optional[StrictStr] = None
    temporalscore: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["basescore", "temporalscore"]
