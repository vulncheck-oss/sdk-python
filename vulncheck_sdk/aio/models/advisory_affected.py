...
class AdvisoryAffected(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.database_specific is None and "database_specific" in self.model_fields_set:
            _dict['database_specific'] = None

        # set to None if ecosystem_specific (nullable) is None
        # and model_fields_set contains the field
        if self.ecosystem_specific is None and "ecosystem_specific" in self.model_fields_set:
            _dict['ecosystem_specific'] = None
