...
class AdvisoryMaliciousVSCodeExts(BaseModel):
    ...
    updated_at: Optional[StrictStr] = Field(default=None, description="the data in this feed comes from manual curation. so this will likely be omitted.")
    url: Optional[StrictStr] = None
    version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["date_added", "name", "publisher", "type", "updated_at", "url", "version"]
