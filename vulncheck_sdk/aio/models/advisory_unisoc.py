...
class AdvisoryUnisoc(BaseModel):
    """
    AdvisoryUnisoc
    """ # noqa: E501
    access_vector: Optional[StrictStr] = None
    affected_chipsets: Optional[StrictStr] = None
    affected_software: Optional[StrictStr] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "access_vector": obj.get("access_vector"),
