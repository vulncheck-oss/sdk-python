...
class AdvisoryVulnrichmentCVERef(BaseModel):
    """
    advisory.VulnrichmentCVERef
    """ # noqa: E501
    containers: Optional[AdvisoryVulnrichmentContainers] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "containers": AdvisoryVulnrichmentContainers.from_dict(obj["containers"]) if obj.get("containers") is not None else None,
