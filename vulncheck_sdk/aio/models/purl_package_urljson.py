...
class PurlPackageURLJSON(BaseModel):
    ...
    qualifiers: Optional[List[PurlQualifierJSON]] = None
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.qualifiers:
            for _item_qualifiers in self.qualifiers:
                _items.append(_item_qualifiers.to_dict() if _item_qualifiers is not None else None)
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "qualifiers": [PurlQualifierJSON.from_dict(_item) for _item in obj["qualifiers"]] if obj.get("qualifiers") is not None else None,
