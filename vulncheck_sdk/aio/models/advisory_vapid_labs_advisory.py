...
class AdvisoryVapidLabsAdvisory(BaseModel):
    """
    ...
    exploit: Optional[StrictStr] = None
    link: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    vapid_id: Optional[StrictStr] = Field(default=None, alias="vapidId")
    vendor: Optional[StrictStr] = None
    vulnerability: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["author", "cve", "date_added", "description", "exploit", "link", "title", "vapidId", "vendor", "vulnerability"]
