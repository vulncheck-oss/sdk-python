...
class ApiTemporalCVSSV3(BaseModel):
    """
    ApiTemporalCVSSV3
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["exploitCodeMaturity", "remediationLevel", "reportConfidence", "temporalScore", "vectorString", "version"]
