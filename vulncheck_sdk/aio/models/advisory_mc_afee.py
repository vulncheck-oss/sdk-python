...
class AdvisoryMcAfee(BaseModel):
    ...
    mcafee_score: Optional[List[AdvisoryMcAfeeScore]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in mcafee_score (list)
        _items = []
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mcafee_score": [AdvisoryMcAfeeScore.from_dict(_item) for _item in obj["mcafee_score"]] if obj.get("mcafee_score") is not None else None,
