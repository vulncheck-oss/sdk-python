...
class AdvisoryProduct(BaseModel):
    ...
    product_identification_helper: Optional[Dict[str, Any]] = Field(default=None, description="advisory.IdentificationHelper")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "product_identification_helper": obj.get("product_identification_helper")
        })
        return _obj
