...
class AdvisoryVCCPEDictionary(BaseModel):
    """
    AdvisoryVCCPEDictionary
    """ # noqa: E501
    base_cpe: Optional[StrictStr] = Field(default=None, alias="baseCPE")
    versions: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["baseCPE", "versions"]
