...
class AdvisoryAndroidAdvisory(BaseModel):
    ...
    """ # noqa: E501
    affected: Optional[List[AdvisoryAndroidAffected]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "affected": [AdvisoryAndroidAffected.from_dict(_item) for _item in obj["affected"]] if obj.get("affected") is not None else None,
