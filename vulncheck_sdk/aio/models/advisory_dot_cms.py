...
class AdvisoryDotCMS(BaseModel):
    """
    AdvisoryDotCMS
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["credit", "cve", "date_added", "description", "fixed_version", "issue_id", "mitigation", "references", "severity", "title", "url"]
