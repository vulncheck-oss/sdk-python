...
class AdvisoryGHVulnerabilities(BaseModel):
    """
    AdvisoryGHVulnerabilities
    """ # noqa: E501
    nodes: Optional[List[AdvisoryGHNode]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": [AdvisoryGHNode.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
