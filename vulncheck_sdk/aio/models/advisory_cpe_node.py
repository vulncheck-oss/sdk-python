...
class AdvisoryCPENode(BaseModel):
    """
    AdvisoryCPENode
    """ # noqa: E501
    cpe_match: Optional[List[AdvisoryCPEMatch]] = Field(default=None, alias="cpeMatch")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cpeMatch": [AdvisoryCPEMatch.from_dict(_item) for _item in obj["cpeMatch"]] if obj.get("cpeMatch") is not None else None,
