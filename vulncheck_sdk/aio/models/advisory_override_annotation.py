...
class AdvisoryOverrideAnnotation(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of triage_notes
        if self.triage_notes:
            _dict['triage_notes'] = self.triage_notes.to_dict()
        return _dict
