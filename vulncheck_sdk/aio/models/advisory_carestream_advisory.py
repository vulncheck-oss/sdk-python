...
class AdvisoryCarestreamAdvisory(BaseModel):
    """
    AdvisoryCarestreamAdvisory
    """ # noqa: E501
    carestream_id: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["carestream_id", "cve", "date_added", "date_last_updated", "title", "updated_at", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "carestream_id": obj.get("carestream_id"),
            "cve": obj.get("cve"),
