...
class AdvisoryRNote(BaseModel):
    ...
    type: Optional[StrictInt] = Field(default=None, description="diff between xml && json")
    __properties: ClassVar[List[str]] = ["audience", "ordinal", "text", "title", "type"]
