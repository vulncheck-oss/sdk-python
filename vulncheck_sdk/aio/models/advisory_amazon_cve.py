...
class AdvisoryAmazonCVE(BaseModel):
    """
    AdvisoryAmazonCVE
    """ # noqa: E501
    affected: Optional[List[AdvisoryAmazonAffectedPackage]] = None
    ...
    __properties: ClassVar[List[str]] = ["affected", "cve", "cvss_score", "cvss_vector", "date_added", "references", "summary", "title", "updated_at", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "affected": [AdvisoryAmazonAffectedPackage.from_dict(_item) for _item in obj["affected"]] if obj.get("affected") is not None else None,
            "cve": obj.get("cve"),
