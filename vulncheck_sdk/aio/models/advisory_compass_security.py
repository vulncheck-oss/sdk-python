...
class AdvisoryCompassSecurity(BaseModel):
    """
    AdvisoryCompassSecurity
    """ # noqa: E501
    csnc_id: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["csnc_id", "cve", "date_added", "effect", "introduction", "product", "references", "risk", "severity", "title", "url", "vendor"]
