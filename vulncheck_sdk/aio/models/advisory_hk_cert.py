...
class AdvisoryHKCert(BaseModel):
    """
    AdvisoryHKCert
    """ # noqa: E501
    ...
    related_links: Optional[List[StrictStr]] = Field(default=None, alias="relatedLinks")
    risk: Optional[StrictStr] = None
    solutions: Optional[StrictStr] = None
    summary: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["affected", "cve", "date_added", "impact", "link", "relatedLinks", "risk", "solutions", "summary", "title", "type"]
