...
class RenderResponseWithMetadataV3controllersPurlResponseDataV3controllersPurlResponseMetadata(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_meta": V3controllersPurlResponseMetadata.from_dict(obj["_meta"]) if obj.get("_meta") is not None else None,
            "data": V3controllersPurlResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
