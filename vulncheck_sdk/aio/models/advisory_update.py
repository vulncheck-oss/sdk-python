...
class AdvisoryUpdate(BaseModel):
    ...
    issued: Optional[Dict[str, Any]] = Field(default=None, description="advisory.DateTime")
    os_arch: Optional[StrictStr] = None
    os_version: Optional[StrictStr] = None
    packages: Optional[List[AdvisoryPackage]] = None
    references: Optional[List[AdvisoryReference]] = None
    severity: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    updated: Optional[Dict[str, Any]] = Field(default=None, description="advisory.DateTime")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "references": [AdvisoryReference.from_dict(_item) for _item in obj["references"]] if obj.get("references") is not None else None,
