...
class AdvisoryCurlAffected(BaseModel):
    """
    AdvisoryCurlAffected
    """ # noqa: E501
    ranges: Optional[List[AdvisoryCurlRange]] = None
    versions: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["ranges", "versions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ranges": [AdvisoryCurlRange.from_dict(_item) for _item in obj["ranges"]] if obj.get("ranges") is not None else None,
