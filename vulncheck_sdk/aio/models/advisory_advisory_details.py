...
class AdvisoryAdvisoryDetails(BaseModel):
    ...
    issued: Optional[Dict[str, Any]] = Field(default=None, description="advisory.Issued")
    severity: Optional[StrictStr] = None
    updated: Optional[Dict[str, Any]] = Field(default=None, description="advisory.Updated")
