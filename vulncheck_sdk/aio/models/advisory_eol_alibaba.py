...
class AdvisoryEOLAlibaba(BaseModel):
    """
    AdvisoryEOLAlibaba
    """ # noqa: E501
    cve: Optional[List[StrictStr]] = None
    eol_date: Optional[StrictStr] = None
    eol_name: Optional[StrictStr] = None
    product: Optional[StrictStr] = None
    release_date: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cve", "eol_date", "eol_name", "product", "release_date", "url", "version"]
