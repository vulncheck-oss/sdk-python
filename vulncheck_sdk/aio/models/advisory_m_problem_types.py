...
class AdvisoryMProblemTypes(BaseModel):
    """
    advisory.MProblemTypes
    """ # noqa: E501
    descriptions: Optional[List[AdvisoryPTMDescriptions]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "descriptions": [AdvisoryPTMDescriptions.from_dict(_item) for _item in obj["descriptions"]] if obj.get("descriptions") is not None else None
        })
        return _obj
