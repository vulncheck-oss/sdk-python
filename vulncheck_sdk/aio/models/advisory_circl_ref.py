...
class AdvisoryCirclRef(BaseModel):
    """
    advisory.CirclRef
    """ # noqa: E501
    containers: Optional[AdvisoryCirclContainers] = None
    cve_metadata: Optional[AdvisoryCirclCveMetadata] = Field(default=None, alias="cveMetadata")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "containers": AdvisoryCirclContainers.from_dict(obj["containers"]) if obj.get("containers") is not None else None,
            "cveMetadata": AdvisoryCirclCveMetadata.from_dict(obj["cveMetadata"]) if obj.get("cveMetadata") is not None else None,
