...
class RenderResponseWithMetadataV3controllersBackupResponseDataV3controllersBackupResponseMetadata(BaseModel):
    """
    ...
    meta: Optional[V3controllersBackupResponseMetadata] = Field(default=None, alias="_meta")
    data: Optional[List[ParamsIndexBackup]] = Field(default=None, description="Data is the data returned by the endpoint")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_meta": V3controllersBackupResponseMetadata.from_dict(obj["_meta"]) if obj.get("_meta") is not None else None,
            "data": [ParamsIndexBackup.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
