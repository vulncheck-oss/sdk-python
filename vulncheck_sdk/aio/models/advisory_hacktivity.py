...
class AdvisoryHacktivity(BaseModel):
    """
    AdvisoryHacktivity
    """ # noqa: E501
    ...
    reports_submitted: Optional[StrictInt] = None
    summary: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cve", "date_added", "float64", "rank", "reports_submitted", "summary", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rank": obj.get("rank"),
            "reports_submitted": obj.get("reports_submitted"),
