...
class AdvisoryGen(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="not all of them have this")
    summary: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["affected", "cve", "cvss_score", "cvss_vector", "date_added", "id", "summary", "title", "url"]
