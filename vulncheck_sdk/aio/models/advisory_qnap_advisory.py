...
class AdvisoryQNAPAdvisory(BaseModel):
    """
    ...
    severity_number: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    summary: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["affected", "bulletin_id", "cve", "date_added", "last_update_date", "link", "severity", "severity_number", "status", "summary", "title"]
