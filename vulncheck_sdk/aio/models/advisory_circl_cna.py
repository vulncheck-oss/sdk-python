...
class AdvisoryCirclCna(BaseModel):
    ...
    source: Optional[AdvisoryCirclSource] = None
    ...
    x_gcve: Optional[List[AdvisoryCirclXGcve]] = None
    x_generator: Optional[AdvisoryCirclXGenerator] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.x_generator:
            _dict['x_generator'] = self.x_generator.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "source": AdvisoryCirclSource.from_dict(obj["source"]) if obj.get("source") is not None else None,
            "tags": obj.get("tags"),
            ...
            "x_gcve": [AdvisoryCirclXGcve.from_dict(_item) for _item in obj["x_gcve"]] if obj.get("x_gcve") is not None else None,
            "x_generator": AdvisoryCirclXGenerator.from_dict(obj["x_generator"]) if obj.get("x_generator") is not None else None
        })
        return _obj
