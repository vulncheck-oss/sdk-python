...
class AdvisoryJohnsonControls(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["affected", "cve", "date_added", "description", "id", "mitigation", "references", "summary", "title", "updated_at", "url"]
