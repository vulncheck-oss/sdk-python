...
class AdvisoryZeroScienceAdvisory(BaseModel):
    """
    ...
    po_c: Optional[StrictStr] = Field(default=None, alias="poC")
    ...
    __properties: ClassVar[List[str]] = ["advisoryId", "affectedVersions", "cve", "date_added", "description", "impact", "link", "poC", "references", "risk", "summary", "title", "type", "vendor"]
