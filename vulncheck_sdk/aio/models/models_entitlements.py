...
class ModelsEntitlements(BaseModel):
    """
    ModelsEntitlements
    """ # noqa: E501
    entitlements: Optional[Dict[str, List[StrictStr]]] = Field(default=None, description="Entitlements provides a map of roles to a list of entitlements")
