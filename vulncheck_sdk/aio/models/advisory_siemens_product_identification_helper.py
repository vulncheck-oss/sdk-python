...
class AdvisorySiemensProductIdentificationHelper(BaseModel):
    """
    AdvisorySiemensProductIdentificationHelper
    """ # noqa: E501
    model_numbers: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["model_numbers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "model_numbers": obj.get("model_numbers")
        })
        return _obj
