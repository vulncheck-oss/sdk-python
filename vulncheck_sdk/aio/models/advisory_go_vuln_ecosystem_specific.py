...
class AdvisoryGoVulnEcosystemSpecific(BaseModel):
    """
    AdvisoryGoVulnEcosystemSpecific
    """ # noqa: E501
    imports: Optional[List[AdvisoryGoVulnImport]] = None
    __properties: ClassVar[List[str]] = ["imports"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "imports": [AdvisoryGoVulnImport.from_dict(_item) for _item in obj["imports"]] if obj.get("imports") is not None else None
        })
        return _obj
