...
class AdvisoryMITREAttackGroupNoID(BaseModel):
    ...
    techniques: Optional[List[AdvisoryMitreAttackTechnique]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "techniques": [AdvisoryMitreAttackTechnique.from_dict(_item) for _item in obj["techniques"]] if obj.get("techniques") is not None else None
        })
        return _obj
