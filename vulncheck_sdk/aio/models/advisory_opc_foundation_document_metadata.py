...
class AdvisoryOPCFoundationDocumentMetadata(BaseModel):
    """
    advisory.OPCFoundationDocumentMetadata
    """ # noqa: E501
    category: Optional[StrictStr] = None
    csaf_version: Optional[StrictStr] = None
    distribution: Optional[AdvisoryOPCFoundationDistribution] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "distribution": AdvisoryOPCFoundationDistribution.from_dict(obj["distribution"]) if obj.get("distribution") is not None else None,
            "lang": obj.get("lang"),
