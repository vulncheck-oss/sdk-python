...
class ApiCveItems(BaseModel):
    """
    ApiCveItems
    """ # noqa: E501
    configurations: Optional[ApiConfigurations] = None
    cve: Optional[ApiCVE] = None
    impact: Optional[ApiImpact] = None
    ...
    __properties: ClassVar[List[str]] = ["configurations", "cve", "impact", "lastModifiedDate", "publishedDate", "vcConfigurations", "vcVulnerableCPEs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cve": ApiCVE.from_dict(obj["cve"]) if obj.get("cve") is not None else None,
            "impact": ApiImpact.from_dict(obj["impact"]) if obj.get("impact") is not None else None,
