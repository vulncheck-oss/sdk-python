...
class AdvisoryAdvisory(BaseModel):
    ...
    AdvisoryAdvisory
    """ # noqa: E501
    affects: Optional[StrictStr] = None
    announced: Optional[StrictStr] = None
    category: Optional[StrictStr] = None
    corrections: Optional[List[AdvisoryCorrection]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "corrections": [AdvisoryCorrection.from_dict(_item) for _item in obj["corrections"]] if obj.get("corrections") is not None else None,
