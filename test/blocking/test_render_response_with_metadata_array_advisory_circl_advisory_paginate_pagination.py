    ...
    def make_instance(self, include_optional) -> RenderResponseWithMetadataArrayAdvisoryCirclAdvisoryPaginatePagination:
        ...
        if include_optional:
            return RenderResponseWithMetadataArrayAdvisoryCirclAdvisoryPaginatePagination(
                ...
                data = [
                    vulncheck_sdk.models.advisory/circl_advisory.advisory.CirclAdvisory(
                        circl_ref = vulncheck_sdk.models.advisory/circl_ref.advisory.CirclRef(
                            containers = vulncheck_sdk.models.advisory/circl_containers.advisory.CirclContainers(
                                adp = [
                                ...
                                cna = vulncheck_sdk.models.advisory/circl_cna.advisory.CirclCna(
                                    date_assigned = '', 
                                    date_public = '', 
                                    rejected_reasons = [
                                    ...
                                    x_generator = vulncheck_sdk.models.advisory/circl_x_generator.advisory.CirclXGenerator(
                                        engine = '', ), ), ), 
                            cve_metadata = vulncheck_sdk.models.advisory/circl_cve_metadata.advisory.CirclCveMetadata(
                                assigner_org_id = '', 
                                assigner_short_name = '', 
                                cve_id = '', 
                                date_published = '', 
