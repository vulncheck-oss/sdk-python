...
class TestAdvisoryCirclCna(unittest.TestCase):
    """AdvisoryCirclCna unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdvisoryCirclCna:
        """Test AdvisoryCirclCna
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdvisoryCirclCna`
        """
        model = AdvisoryCirclCna()
        if include_optional:
            return AdvisoryCirclCna(
                affected = [
                ...
                problem_types = [
                    vulncheck_sdk.aio.models.advisory/m_problem_types.advisory.MProblemTypes(
                        descriptions = [
                            vulncheck_sdk.aio.models.advisory/ptm_descriptions.advisory.PTMDescriptions(
                                cwe_id = '', 
                                description = '', 
                                lang = '', 
                                references = [
