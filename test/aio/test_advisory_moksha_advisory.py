...
class TestAdvisoryMokshaAdvisory(unittest.TestCase):
    """AdvisoryMokshaAdvisory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdvisoryMokshaAdvisory:
        """Test AdvisoryMokshaAdvisory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdvisoryMokshaAdvisory`
        """
        model = AdvisoryMokshaAdvisory()
        if include_optional:
            return AdvisoryMokshaAdvisory(
                cve = [
                    ''
                    ],
    ...
    def testAdvisoryMokshaAdvisory(self):
        """Test AdvisoryMokshaAdvisory"""
