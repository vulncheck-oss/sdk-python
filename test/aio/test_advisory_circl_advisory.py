...
class TestAdvisoryCirclAdvisory(unittest.TestCase):
    """AdvisoryCirclAdvisory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdvisoryCirclAdvisory:
        """Test AdvisoryCirclAdvisory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdvisoryCirclAdvisory`
        """
        model = AdvisoryCirclAdvisory()
        if include_optional:
            return AdvisoryCirclAdvisory(
    ...
    def testAdvisoryCirclAdvisory(self):
        """Test AdvisoryCirclAdvisory"""
