...
class TestAdvisoryCirclContainers(unittest.TestCase):
    """AdvisoryCirclContainers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdvisoryCirclContainers:
        """Test AdvisoryCirclContainers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdvisoryCirclContainers`
        """
        model = AdvisoryCirclContainers()
        if include_optional:
            return AdvisoryCirclContainers(
                adp = [
    ...
    def testAdvisoryCirclContainers(self):
        """Test AdvisoryCirclContainers"""
