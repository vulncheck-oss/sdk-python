...
class TestRenderResponseWithMetadataArrayAdvisoryMokshaAdvisoryPaginatePagination(unittest.TestCase):
    """RenderResponseWithMetadataArrayAdvisoryMokshaAdvisoryPaginatePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RenderResponseWithMetadataArrayAdvisoryMokshaAdvisoryPaginatePagination:
        """Test RenderResponseWithMetadataArrayAdvisoryMokshaAdvisoryPaginatePagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RenderResponseWithMetadataArrayAdvisoryMokshaAdvisoryPaginatePagination`
        """
        model = RenderResponseWithMetadataArrayAdvisoryMokshaAdvisoryPaginatePagination()
        if include_optional:
            return RenderResponseWithMetadataArrayAdvisoryMokshaAdvisoryPaginatePagination(
                benchmark = 1.337,
                ...
                data = [
                    vulncheck_sdk.aio.models.advisory/moksha_advisory.advisory.MokshaAdvisory(
                        cve = [
                            ''
                            ], 
                        cve_ref = vulncheck_sdk.aio.models.advisory/mitre_cve_list_v5_ref.advisory.MitreCVEListV5Ref(
    ...
    def testRenderResponseWithMetadataArrayAdvisoryMokshaAdvisoryPaginatePagination(self):
        """Test RenderResponseWithMetadataArrayAdvisoryMokshaAdvisoryPaginatePagination"""
