...
class TestAdvisoryCirclRef(unittest.TestCase):
    """AdvisoryCirclRef unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdvisoryCirclRef:
        """Test AdvisoryCirclRef
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdvisoryCirclRef`
        """
        model = AdvisoryCirclRef()
        if include_optional:
            return AdvisoryCirclRef(
