    ...
    def make_instance(self, include_optional) -> ApiCveItemsExtended:
        ...
        if include_optional:
            return ApiCveItemsExtended(
                timestamp = '',
                configurations = vulncheck_sdk.aio.models.api/configurations.api.Configurations(
                    cve_data_version = '', 
                    nodes = [
                        vulncheck_sdk.aio.models.api/nodes.api.Nodes(
                            children = [
                                vulncheck_sdk.aio.models.api/nodes.api.Nodes(
                                    cpe_match = [
                                        vulncheck_sdk.aio.models.api/cpe_match.api.CPEMatch(
                                            cpe22_uri = '', 
                                            cpe23_uri = '', 
                                            cpe_name = [
                                                vulncheck_sdk.aio.models.api/cpe_name.api.CPEName(
                                                    cpe22_uri = '', 
                                                    cpe23_uri = '', 
                                                    last_modified_date = '', )
                                                ], 
                ...
                cve = vulncheck_sdk.aio.models.api/cve_extended.api.CVEExtended(
                    cve_data_meta = vulncheck_sdk.aio.models.api/cve_data_meta_extended.api.CVEDataMetaExtended(
                        alias = '', 
                        assigner = '', 
                        id = '', 
                        status = '', ), 
                    ...
                    problemtype = vulncheck_sdk.aio.models.api/problem_type_extended.api.ProblemTypeExtended(
                        problemtype_data = [
                            vulncheck_sdk.aio.models.api/problem_type_data_extended.api.ProblemTypeDataExtended()
                            ], ), 
                    references = vulncheck_sdk.aio.models.api/references_extended.api.ReferencesExtended(
                        reference_data = [
                            vulncheck_sdk.aio.models.api/reference_data_extended.api.ReferenceDataExtended(
                                date_added = '', 
                                external_id = '', 
                                lang = '', 
                                name = '', 
                ...
                impact = vulncheck_sdk.aio.models.api/impact_extended.api.ImpactExtended(
                    base_metric_v2 = vulncheck_sdk.aio.models.api/base_metric_v2.api.BaseMetricV2(
                        ac_insuf_info = True, 
                        cvss_v2 = vulncheck_sdk.aio.models.api/cvssv2.api.CVSSV2(
                            access_complexity = '', 
                            access_vector = '', 
                            authentication = '', 
                            availability_impact = '', 
                    ...
                    temporal_metric_v2 = vulncheck_sdk.aio.models.api/temporal_metric_v2.api.TemporalMetricV2(), 
                    temporal_metric_v3 = vulncheck_sdk.aio.models.api/temporal_metric_v3.api.TemporalMetricV3(), 
                    temporal_v3_corrected = vulncheck_sdk.aio.models.api/temporal_metric_v3.api.TemporalMetricV3(), 
                    threat_metric_v40 = vulncheck_sdk.aio.models.advisory/cvssv40_threat.advisory.CVSSV40Threat(
