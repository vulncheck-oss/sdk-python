    ...
    def make_instance(self, include_optional) -> RenderResponseWithMetadataV3controllersBackupResponseDataV3controllersBackupResponseMetadata:
        ...
        if include_optional:
            return RenderResponseWithMetadataV3controllersBackupResponseDataV3controllersBackupResponseMetadata(
                benchmark = 1.337,
                meta = vulncheck_sdk.aio.models.v3controllers/backup_response_metadata.v3controllers.BackupResponseMetadata(
                    index = '', 
                    timestamp = '', ),
                data = [
                    vulncheck_sdk.aio.models.params/index_backup.params.IndexBackup(
                        date_added = '', 
                        filename = '', 
                        sha256 = '', 
                        url = '', 
