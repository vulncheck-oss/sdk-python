...
class TestSearchV4AdvisoryReturnValue(unittest.TestCase):
    """SearchV4AdvisoryReturnValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchV4AdvisoryReturnValue:
        """Test SearchV4AdvisoryReturnValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchV4AdvisoryReturnValue`
        """
        model = SearchV4AdvisoryReturnValue()
        if include_optional:
            return SearchV4AdvisoryReturnValue(
                meta = vulncheck_sdk.aio.models.search/v4_advisory_meta.search.V4AdvisoryMeta(
                    cursor = '', 
                    filtered = 56, 
                    limit = 56, 
                    next_cursor = '', 
                    ...
                    total = 56, ),
                data = [
                    vulncheck_sdk.aio.models.advisory/mitre_cve_list_v5_ref.advisory.MitreCVEListV5Ref(
    ...
    def testSearchV4AdvisoryReturnValue(self):
        """Test SearchV4AdvisoryReturnValue"""
